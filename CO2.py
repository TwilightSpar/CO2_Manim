...
class M1(Scene):
    def construct(self):
        M1_Tis_1 = MathTex(r"V_{tis} \derivative{P_{tis} }{t} = \frac {M_{tis} } {k} + Q(P_a^*-P_{tis}) ").shift(UP)
        ...
        M1_Tis_1_equal_0_3 = MathTex(r"QP_{tis} = \frac {M_{tis} } {k} + QP_a^*").shift(UP)
        ...
        self.wait()
        self.play(M1_Tis_1.animate.shift(UP))

        self.play(Write(M1_Tis_1_equal_0_1))
        self.wait()
        self.remove(M1_Tis_1)
        self.wait()
        ...
        self.wait()
        self.play(M1_Tis_1_equal_0_2.animate.shift(UP))
        self.wait()

        self.play(Write(M1_Tis_1_equal_0_3))
        self.wait()
        self.remove(M1_Tis_1_equal_0_2)
        self.wait()
